$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','做蛋糕啦','生日快乐星宝，一切玩得开心喔');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 1){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','哇，混合成功啦，宝超棒耶','');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','烘焙好啦，马上就能吃到蛋糕啦，好兴奋','星宝继续加油喔');
    }
})
